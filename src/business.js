/**
 * baa.haus — Business Page Typing Animation
 */

// Configuration
const headerText = 'which one?';
const menuItems = ['le carrousel', 'attirer grandeur'];
...
function typeHeader() {
  if (currentIndex < headerText.length) {
    businessText.textContent += headerText.charAt(currentIndex);
    currentIndex++;
